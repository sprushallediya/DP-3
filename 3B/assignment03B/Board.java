...
public class Board {
    ...
    public String getICCF(int code) { 
        int file = (code / 10);
        int rank = (code % 10);
    ...
    public void initializeBoard() {
        setICCF(11, "WR"); setICCF(21, "WN"); setICCF(31, "WB"); setICCF(41, "WQ");
        setICCF(51, "WK"); setICCF(61, "WB"); setICCF(71, "WN"); setICCF(81, "WR");
        for (int k = 1; k <= 8; k++) setICCF(10 * k + 2, "WP");
        for (int k = 1; k <= 8; k++) setICCF(10 * k + 7, "BP");
        setICCF(18, "BR"); setICCF(28, "BN"); setICCF(38, "BB"); setICCF(48, "BQ");
        setICCF(58, "BK"); setICCF(68, "BB"); setICCF(78, "BN"); setICCF(88, "BR");
    }

    public void doNewCommand(Command cm) {
        originator.createMemento(this, cm); // Save state
        cm.execute(); 
    }

    public void undoCommand() {
        originator.reset(this); 
    }
